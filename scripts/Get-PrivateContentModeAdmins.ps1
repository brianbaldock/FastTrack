<#
    ...
    .EXAMPLE
        .\Get-PrivateContentModeAdmins.ps1 -DeveloperToken < ###########-##################### >
    
    .EXAMPLE
        .\Get-PrivateContentModeAdmins.ps1 -DeveloperToken < ###########-##################### > | Export-CSv -Path "C:\scripts\PrivateContentModeAdmins.csv" -NoTypeInformation
#>
